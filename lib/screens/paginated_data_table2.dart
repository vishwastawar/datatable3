...
import '../src/paginated_data_table_2.dart';
...
class PaginatedDataTable2DemoState extends State<PaginatedDataTable2Demo> {
  ...
  void sort<T>(
    ...
    setState(() {
      ...
      print("${_sortAscending},${_sortColumnIndex}this is sorting ");
    });
  }
  ...
  Widget build(BuildContext context) {
    if(_controller!.isAttached) {
      ...
      print(_controller!.currentRowIndex.toString());
    }
    return Stack(alignment: Alignment.bottomCenter, children: [
      PaginatedDataTable2(
        ...
        onRowsPerPageChanged: (value) {
          _rowsPerPage = value!;
          limit = value;
          print("this is from paginated_data_table2 Limit$_rowsPerPage");
        },
